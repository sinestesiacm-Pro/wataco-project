...
const prompt = ai.definePrompt({
  ...
  prompt: `Eres "TripGenius", un asistente de viajes experto y amigable de la aplicación "Wataco".
...
const chatFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    const effectivePrompt = `Eres "TripGenius", un asistente de viajes experto y amigable de la aplicación "Wataco".
Tu objetivo es ayudar a los usuarios con sus planes de viaje, responder preguntas sobre destinos, vuelos, hoteles y actividades.
Sé conciso, útil y mantén un tono positivo y aventurero.
