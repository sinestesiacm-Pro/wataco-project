...
export const recommendedCruises: CruisePackage[] = [
  {
    ...
    price: '980',
    itinerary: [
      { day: 1, port: 'Miami, USA', arrival: 'Embark', departure: '18:00', countryCode: 'us', image: 'https://images.unsplash.com/photo-1533106497176-45ae19e68ba2' },
      { day: 2, port: 'Nassau, Bahamas', arrival: '08:00', departure: '17:00', countryCode: 'bs', image: 'https://images.unsplash.com/photo-1605649487212-47aab0baf853' },
      { day: 3, port: 'At Sea', arrival: 'High Seas', departure: '', isAtSea: true },
      { day: 4, port: 'Charlotte Amalie, St. Thomas', arrival: '08:00', departure: '18:00', countryCode: 'vi', image: 'https://images.unsplash.com/photo-1533492866952-4a3b11a51191' },
      ...
      { day: 7, port: 'Miami, USA', arrival: '06:00', departure: 'Disembark', countryCode: 'us', image: 'https://images.unsplash.com/photo-1533106497176-45ae19e68ba2' },
    ],
  },
  {
    ...
    price: '1850',
    itinerary: [
      { day: 1, port: 'Seattle, USA', arrival: 'Embark', departure: '18:00', countryCode: 'us', image: 'https://images.unsplash.com/photo-1591809457304-807e3b1458b1' },
      { day: 2, port: 'At Sea', arrival: 'High Seas', departure: '', isAtSea: true },
      { day: 3, port: 'Ketchikan, Alaska', arrival: '08:00', departure: '18:00', countryCode: 'us', image: 'https://images.unsplash.com/photo-1565507743329-3a83e08f51a7' },
      { day: 4, port: 'Juneau, Alaska', arrival: '07:00', departure: '16:00', countryCode: 'us', image: 'https://images.unsplash.com/photo-1620894569527-040213bff714' },
      { day: 5, port: 'Skagway, Alaska', arrival: '09:00', departure: '19:00', countryCode: 'us', image: 'https://images.unsplash.com/photo-1592659056314-a99ace460e5e' },
      { day: 6, port: 'Glacier Bay National Park', arrival: 'Scenic Cruising', departure: '', isAtSea: true, image: 'https://images.unsplash.com/photo-1548081213-65299042a99d' },
      { day: 7, port: 'At Sea', arrival: 'High Seas', departure: '', isAtSea: true },
      { day: 8, port: 'Seward, Alaska', arrival: '08:00', departure: 'Disembark', countryCode: 'us', image: 'https://images.unsplash.com/photo-1607318532457-3a677b1b59cb' },
    ]
  },
  {
    ...
    price: '1120',
    itinerary: [
      { day: 1, port: 'San Juan, Puerto Rico', arrival: 'Embark', departure: '20:00', countryCode: 'pr', image: 'https://images.unsplash.com/photo-1615579767222-1d8c68a46355' },
      { day: 2, port: 'At Sea', arrival: 'High Seas', departure: '', isAtSea: true },
      ...
      { day: 4, port: 'Castries, St. Lucia', arrival: '08:00', departure: '17:00', countryCode: 'lc', image: 'https://images.unsplash.com/photo-1591244365744-86a73a380482' },
      { day: 5, port: "St. John's, Antigua", arrival: '08:00', departure: '17:00', countryCode: 'ag', image: 'https://images.unsplash.com/photo-1606323842345-3f9f688585e3' },
      ...
      { day: 7, port: 'San Juan, Puerto Rico', arrival: '06:00', departure: 'Disembark', countryCode: 'pr', image: 'https://images.unsplash.com/photo-1615579767222-1d8c68a46355' },
    ],
  },
  {
