  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-4xl w-[95%] max-h-[90vh] flex flex-col bg-transparent p-0 border-0 shadow-none">
        {details ? (
            <div className="bg-card/80 backdrop-blur-2xl rounded-3xl shadow-2xl overflow-hidden border flex flex-col h-full">
              ...
              <div className="flex-grow min-h-0">
                  <ScrollArea className="h-full">
                      <div className="flex flex-col md:flex-row p-4 md:p-8 pt-4">
                          {/* Main Ticket Area */}
                          ...
                          {/* Tear-off Stub Area */}
                          <div className="w-full md:w-64 flex-shrink-0 bg-muted/40 ticket-tear flex flex-col items-center justify-between p-6 mt-6 md:mt-0 rounded-lg">
