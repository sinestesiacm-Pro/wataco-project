...
const cloudData = [
  ...
  { top: '15%', left: '0%', scale: 1.8, duration: '180s', delay: '-5s' },
  { top: '60%', left: '5%', scale: 2.0, duration: '200s', delay: '-100s' },
  { top: '5%', left: '80%', scale: 1.7, duration: '220s', delay: '-180s' },

  // Capa 2: Nubes medianas a velocidad moderada
  { top: '25%', left: '70%', scale: 1.4, duration: '150s', delay: '-20s' },
  { top: '40%', left: '85%', scale: 1.2, duration: '160s', delay: '-120s' },
  { top: '75%', left: '50%', scale: 1.5, duration: '170s', delay: '-40s' },
  { top: '80%', left: '10%', scale: 1.6, duration: '190s', delay: '-150s' },
  ...
  // --- Nubes Adicionales Intercaladas para evitar colisiones ---
  { top: '10%', left: '95%', scale: 1.5, duration: '185s', delay: '-35s' },
  { top: '35%', left: '0%', scale: 1.9, duration: '210s', delay: '-110s' },
  { top: '70%', left: '85%', scale: 1.3, duration: '165s', delay: '-75s' },
  { top: '90%', left: '15%', scale: 1.8, duration: '195s', delay: '-25s' },
  { top: '20%', left: '55%', scale: 1.1, duration: '115s', delay: '-55s' },
  { top: '55%', left: '70%', scale: 1.6, duration: '175s', delay: '-5s' },
  { top: '88%', left: '45%', scale: 1.4, duration: '155s', delay: '-130s' },
  { top: '2%', left: '20%', scale: 1.2, duration: '125s', delay: '-45s' },
  { top: '45%', left: '5%', scale: 1.7, duration: '205s', delay: '-150s' },
  { top: '80%', left: '90%', scale: 1.2, duration: '145s', delay: '-85s' },
];
        ...
        {cloudData.map((cloud, index) => {
          ...
          return (
            <Cloud key={index} style={{
                ...
                transform: `scale(${cloud.scale}) translateX(-100%)`, // Start off-screen
                '--cloud-start-x': '0%', // Animation will move it from its 'left' position
                '--cloud-end-x': 'calc(100vw + 300px)', // Move across the screen and off
