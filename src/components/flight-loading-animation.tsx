...
const WelcomeAboardCloud = () => {
    const words = [
        ...
        // Tier 3 - 10 more languages
        { text: "Hoş geldiniz", size: "text-xl", position: "top-[15%] left-[25%]", opacity: "opacity-60", duration: "18s", delay: "-3s" }, // Turkish
        { text: "Witamy na pokładzie", size: "text-lg", position: "top-[18%] right-[18%]", opacity: "opacity-50", duration: "17s", delay: "-5s" }, // Polish
        { text: "Chào mừng quý khách", size: "text-md", position: "top-[70%] left-[40%]", opacity: "opacity-70", duration: "19s", delay: "-7s" }, // Vietnamese
        { text: "ยินดีต้อนรับ", size: "text-2xl", position: "top-[75%] right-[30%]", opacity: "opacity-80", duration: "16s", delay: "-9s" }, // Thai
        { text: "ברוכים הבאים", size: "text-xl", position: "bottom-[10%] left-[50%]", opacity: "opacity-65", duration: "20s", delay: "-1s" }, // Hebrew
        { text: "Καλώς ήρθατε", size: "text-2xl", position: "bottom-[40%] left-[10%]", opacity: "opacity-75", duration: "18s", delay: "-11s" }, // Greek
        { text: "Üdv a fedélzeten", size: "text-lg", position: "bottom-[45%] right-[15%]", opacity: "opacity-60", duration: "17s", delay: "-13s" }, // Hungarian
        { text: "Tervetuloa laivaan", size: "text-md", position: "top-[5%] left-[50%]", opacity: "opacity-50", duration: "22s", delay: "-15s" }, // Finnish
        { text: "Vítejte na palubě", size: "text-xl", position: "bottom-[5%] right-[50%]", opacity: "opacity-70", duration: "21s", delay: "-17s" }, // Czech
        { text: "Selamat datang", size: "text-2xl", position: "top-[80%] left-[15%]", opacity: "opacity-80", duration: "19s", delay: "-19s" }, // Indonesian
    ];
