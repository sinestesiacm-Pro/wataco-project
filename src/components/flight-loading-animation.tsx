...
const WelcomeAboardCloud = () => {
    const words = [
        ...
        // Tier 4 (Duplicates and New Languages for Volume)
        { text: "Bine ați venit la bord", size: "text-lg", position: "top-[85%] left-[50%]", opacity: "opacity-70", duration: "20s", delay: "-20s" }, // Romanian
        { text: "Velkommen ombord", size: "text-xl", position: "top-[10%] right-[40%]", opacity: "opacity-60", duration: "21s", delay: "-21s" }, // Danish
        { text: "Velkommen om bord", size: "text-md", position: "bottom-[10%] left-[10%]", opacity: "opacity-65", duration: "19s", delay: "-22s" }, // Norwegian
        { text: "Karibu ndani", size: "text-lg", position: "top-[80%] right-[10%]", opacity: "opacity-75", duration: "18s", delay: "-23s" }, // Swahili
        { text: "Maligayang pagdating", size: "text-lg", position: "bottom-[30%] left-[25%]", opacity: "opacity-70", duration: "23s", delay: "-24s" }, // Filipino
        { text: "Selamat datang di kapal", size: "text-lg", position: "top-[5%] right-[10%]", opacity: "opacity-60", duration: "24s", delay: "-25s" }, // Malay
        { text: "Benvinguts a bord", size: "text-md", position: "bottom-[40%] right-[30%]", opacity: "opacity-70", duration: "22s", delay: "-26s" }, // Catalan
        { text: "Vitajte na palube", size: "text-xl", position: "top-[50%] left-[5%]", opacity: "opacity-80", duration: "20s", delay: "-27s" }, // Slovak
        { text: "Dobrodošli na krovu", size: "text-md", position: "top-[65%] right-[45%]", opacity: "opacity-65", duration: "25s", delay: "-28s" }, // Slovenian
        { text: "Velkomin um borð", size: "text-lg", position: "bottom-[15%] right-[70%]", opacity: "opacity-75", duration: "21s", delay: "-29s" }, // Icelandic
    ...
    return (
        <div className="relative w-full h-96 text-white font-headline">
...
export function FlightLoadingAnimation({ originName, destinationName }: FlightLoadingAnimationProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center py-16 space-y-8 overflow-hidden w-full h-full">
            <WelcomeAboardCloud />
            <div className="relative z-10 bg-black/20 backdrop-blur-sm p-4 rounded-xl">
