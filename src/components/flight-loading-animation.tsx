...
const words = [
    ...
    { text: "Välkommen ombord", size: "text-lg", opacity: "opacity-70", top: '85%', left: '-5%', fontWeight: '300', duration: '45s', delay: '-15s' },
    ...
    { text: "Καλώς ήρθατε", size: "text-lg", opacity: "opacity-70", top: '-8%', left: '5%', fontWeight: '300', duration: '48s', delay: '-20s' },
    ...
    { text: "Üdvözöljük a fedélzeten", size: "text-lg", opacity: "opacity-70", top: '38%', left: '-15%', fontWeight: '300', duration: '50s', delay: '-22s' },
    ...
    { text: "Chào mừng", size: "text-lg", opacity: "opacity-75", top: '5%', left: '45%', fontWeight: '300', duration: '45s', delay: '-21s' },
    ...
    { text: "Benvido a bordo", size: "text-lg", opacity: "opacity-70", top: '55%', left: '-12%', fontWeight: '300', duration: '48s', delay: '-23s' },
    ...
    { text: "Üdv a fedélzeten", size: "text-lg", opacity: "opacity-70", top: '112%', left: '40%', fontWeight: '300', duration: '48s', delay: '-23s' },
    ...
    { text: "Hoş geldin", size: "text-lg", opacity: "opacity-75", top: '75%', left: '35%', fontWeight: '300', duration: '43s', delay: '-19s' },
    ...
    { text: "Chào đón", size: "text-lg", opacity: "opacity-75", top: '30%', left: '40%', fontWeight: '300', duration: '46s', delay: '-22s' },
    ...
    // More elements
    { text: "ยินดีต้อนรับ", size: "text-2xl", opacity: "opacity-90", top: '5%', left: '5%', fontWeight: '600', duration: '28s', delay: '-4s' },
    { text: "Sveiki atvykę į laivą", size: "text-lg", opacity: "opacity-70", top: '95%', left: '95%', fontWeight: '300', duration: '48s', delay: '-24s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '12%', left: '88%', fontWeight: '500', duration: '37s', delay: '-11s' },
    { text: " aboard", size: "text-3xl", opacity: "opacity-90", top: '88%', left: '12%', fontWeight: '700', duration: '26s', delay: '-2s' },
    { text: " aboard", size: "text-2xl", opacity: "opacity-85", top: '48%', left: '48%', fontWeight: '600', duration: '33s', delay: '-8s' },
    { text: " aboard", size: "text-lg", opacity: "opacity-75", top: '22%', left: '78%', fontWeight: '400', duration: '42s', delay: '-18s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '78%', left: '22%', fontWeight: '500', duration: '39s', delay: '-15s' },
    { text: " aboard", size: "text-4xl", opacity: "opacity-100", top: '50%', left: '50%', fontWeight: '700', duration: '25s', delay: '0s' },
    { text: " aboard", size: "text-2xl", opacity: "opacity-85", top: '10%', left: '10%', fontWeight: '600', duration: '31s', delay: '-6s' },
    { text: " aboard", size: "text-lg", opacity: "opacity-70", top: '90%', left: '90%', fontWeight: '300', duration: '50s', delay: '-25s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '30%', left: '70%', fontWeight: '500', duration: '38s', delay: '-13s' },
    { text: " aboard", size: "text-3xl", opacity: "opacity-90", top: '70%', left: '30%', fontWeight: '700', duration: '27s', delay: '-3s' },
    { text: " aboard", size: "text-2xl", opacity: "opacity-85", top: '5%', left: '95%', fontWeight: '600', duration: '34s', delay: '-9s' },
    { text: " aboard", size: "text-lg", opacity: "opacity-75", top: '95%', left: '5%', fontWeight: '400', duration: '45s', delay: '-20s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '40%', left: '60%', fontWeight: '500', duration: '36s', delay: '-12s' },
    { text: " aboard", size: "text-2xl", opacity: "opacity-85", top: '60%', left: '40%', fontWeight: '600', duration: '32s', delay: '-7s' },
    { text: " aboard", size: "text-lg", opacity: "opacity-70", top: '15%', left: '85%', fontWeight: '300', duration: '47s', delay: '-22s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '85%', left: '15%', fontWeight: '500', duration: '40s', delay: '-16s' },
    { text: " aboard", size: "text-3xl", opacity: "opacity-90", top: '25%', left: '75%', fontWeight: '700', duration: '29s', delay: '-5s' },
    { text: " aboard", size: "text-2xl", opacity: "opacity-85", top: '75%', left: '25%', fontWeight: '600', duration: '35s', delay: '-10s' },
    { text: " aboard", size: "text-lg", opacity: "opacity-75", top: '2%', left: '50%', fontWeight: '400', duration: '43s', delay: '-19s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '98%', left: '50%', fontWeight: '500', duration: '37s', delay: '-14s' },
    { text: " aboard", size: "text-2xl", opacity: "opacity-85", top: '50%', left: '2%', fontWeight: '600', duration: '30s', delay: '-4s' },
    { text: " aboard", size: "text-lg", opacity: "opacity-70", top: '50%', left: '98%', fontWeight: '300', duration: '49s', delay: '-24s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '20%', left: '80%', fontWeight: '500', duration: '41s', delay: '-17s' },
    { text: " aboard", size: "text-3xl", opacity: "opacity-90", top: '80%', left: '20%', fontWeight: '700', duration: '26s', delay: '-1s' },
    { text: " aboard", size: "text-2xl", opacity: "opacity-85", top: '33%', left: '33%', fontWeight: '600', duration: '32s', delay: '-7s' },
    { text: " aboard", size: "text-lg", opacity: "opacity-75", top: '66%', left: '66%', fontWeight: '400', duration: '46s', delay: '-21s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '11%', left: '89%', fontWeight: '500', duration: '38s', delay: '-13s' },
    { text: " aboard", size: "text-2xl", opacity: "opacity-85", top: '89%', left: '11%', fontWeight: '600', duration: '29s', delay: '-5s' },
    { text: " aboard", size: "text-lg", opacity: "opacity-70", top: '44%', left: '56%', fontWeight: '300', duration: '48s', delay: '-23s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '56%', left: '44%', fontWeight: '500', duration: '36s', delay: '-11s' },
    { text: " aboard", size: "text-3xl", opacity: "opacity-90", top: '28%', left: '72%', fontWeight: '700', duration: '27s', delay: '-3s' },
    { text: " aboard", size: "text-2xl", opacity: "opacity-85", top: '72%', left: '28%', fontWeight: '600', duration: '34s', delay: '-9s' },
    { text: " aboard", size: "text-lg", opacity: "opacity-75", top: '7%', left: '93%', fontWeight: '400', duration: '44s', delay: '-20s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '93%', left: '7%', fontWeight: '500', duration: '40s', delay: '-16s' },
    { text: " aboard", size: "text-2xl", opacity: "opacity-85", top: '18%', left: '82%', fontWeight: '600', duration: '31s', delay: '-6s' },
    { text: " aboard", size: "text-lg", opacity: "opacity-70", top: '82%', left: '18%', fontWeight: '300', duration: '50s', delay: '-25s' },
    { text: " aboard", size: "text-xl", opacity: "opacity-80", top: '35%', left: '65%', fontWeight: '500', duration: '37s', delay: '-12s' },
    { text: " aboard", size: "text-3xl", opacity: "opacity-90", top: '65%', left: '35%', fontWeight: '700', duration: '28s', delay: '-4s' },
];
