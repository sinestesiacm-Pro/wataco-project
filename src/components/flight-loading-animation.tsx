...
const words = [
    ...
    { text: "어서 오세요", size: "text-3xl", opacity: "opacity-90", top: '60%', left: '5%', fontWeight: '600', duration: '29s', delay: '-7s' },
    { text: "ようこそ", size: "text-xl", opacity: "opacity-80", top: '90%', left: '85%', fontWeight: '500', duration: '38s', delay: '-14s' },
    { text: "歡迎光臨", size: "text-3xl", opacity: "opacity-85", top: '10%', left: '55%', fontWeight: '600', duration: '27s', delay: '-1s' },
    { text: "Selamat datang", size: "text-lg", opacity: "opacity-75", top: '80%', left: '60%', fontWeight: '400', duration: '42s', delay: '-18s' },
    { text: "Fáilte ar bord", size: "text-2xl", opacity: "opacity-90", top: '25%', left: '45%', fontWeight: '500', duration: '31s', delay: '-6s' },
    { text: "Witamy na pokładzie", size: "text-xl", opacity: "opacity-80", top: '75%', left: '90%', fontWeight: '400', duration: '36s', delay: '-11s' },
    { text: "Hoş geldiniz", size: "text-2xl", opacity: "opacity-85", top: '40%', left: '90%', fontWeight: '500', duration: '34s', delay: '-9s' },
    { text: "Καλώς ήρθατε", size: "text-lg", opacity: "opacity-70", top: '5%', left: '5%', fontWeight: '400', duration: '48s', delay: '-20s' },
    { text: "Ласкаво просимо", size: "text-xl", opacity: "opacity-85", top: '95%', left: '50%', transform: 'translateX(-50%)', fontWeight: '500', duration: '37s', delay: '-13s' },
    ...
    { text: "Failte", size: "text-xl", opacity: "opacity-80", top: '5%', left: '85%', fontWeight: '500', duration: '35s', delay: '-10s' },
    { text: "Croeso ar fwrdd", size: "text-2xl", opacity: "opacity-85", top: '92%', left: '15%', fontWeight: '500', duration: '32s', delay: '-8s' },
    { text: "Üdvözöljük a fedélzeten", size: "text-lg", opacity: "opacity-70", top: '38%', left: '5%', fontWeight: '400', duration: '50s', delay: '-22s' },
    { text: "Barka da zuwa", size: "text-xl", opacity: "opacity-75", top: '58%', left: '85%', fontWeight: '400', duration: '41s', delay: '-18s' },
    { text: "Bine aţi venit", size: "text-lg", opacity: "opacity-70", top: '28%', left: '95%', fontWeight: '400', duration: '49s', delay: '-21s' },
    ...
    { text: "Sveiki atvykę", size: "text-lg", opacity: "opacity-70", top: '95%', left: '75%', fontWeight: '400', duration: '47s', delay: '-23s' },
    { text: "Tere tulemast", size: "text-2xl", opacity: "opacity-80", top: '2%', left: '70%', fontWeight: '500', duration: '34s', delay: '-8s' },
    ...
    { text: "Onthaal aan boord", size: "text-xl", opacity: "opacity-70", top: '50%', left: '80%', fontWeight: '400', duration: '40s', delay: '-16s' },
    { text: "Velkommen", size: "text-2xl", opacity: "opacity-80", top: '5%', left: '15%', fontWeight: '500', duration: '35s', delay: '-10s' },
    { text: "Mire se vini", size: "text-lg", opacity: "opacity-70", top: '95%', left: '10%', fontWeight: '400', duration: '49s', delay: '-24s' },
    { text: "ברוך הבא", size: "text-2xl", opacity: "opacity-80", top: '15%', left: '5%', fontWeight: '500', direction: 'rtl', duration: '32s', delay: '-7s' },
    { text: "Ongi etorri", size: "text-xl", opacity: "opacity-75", top: '85%', left: '95%', fontWeight: '400', duration: '42s', delay: '-18s' },
    { text: "Добре дошли", size: "text-2xl", opacity: "opacity-85", top: '75%', left: '50%', fontWeight: '500', duration: '33s', delay: '-9s' },
    { text: "Benvido a bordo", size: "text-lg", opacity: "opacity-70", top: '55%', left: '10%', fontWeight: '400', duration: '48s', delay: '-23s' },
    { text: "Välkommen", size: "text-2xl", opacity: "opacity-80", top: '48%', left: '25%', fontWeight: '500', duration: '36s', delay: '-12s' },
    { text: "Tere tulemast pardale", size: "text-lg", opacity: "opacity-70", top: '25%', left: '85%', fontWeight: '400', duration: '47s', delay: '-22s' },
    { text: "Maligayang pagdating sa board", size: "text-xl", opacity: "opacity-75", top: '65%', left: '20%', fontWeight: '400', duration: '43s', delay: '-19s' },
    { text: "Tervetuloa alukseen", size: "text-lg", opacity: "opacity-70", top: '70%', left: '80%', fontWeight: '400', duration: '44s', delay: '-20s' },
    { text: "Soo dhawow", size: "text-2xl", opacity: "opacity-85", top: '85%', left: '20%', fontWeight: '500', duration: '34s', delay: '-8s' },
    { text: "Selamat di kapal", size: "text-lg", opacity: "opacity-70", top: '10%', left: '90%', fontWeight: '400', duration: '50s', delay: '-25s' },
    ...
    { text: "Üdv a fedélzeten", size: "text-lg", opacity: "opacity-70", top: '80%', left: '40%', fontWeight: '400', duration: '48s', delay: '-23s' },
    { text: "Vitajte na palube", size: "text-xl", opacity: "opacity-75", top: '50%', left: '40%', fontWeight: '400', duration: '39s', delay: '-15s' },
    { text: "Mire se erdhët në bord", size: "text-lg", opacity: "opacity-70", top: '20%', left: '60%', fontWeight: '400', duration: '47s', delay: '-22s' },
    ...
    { text: "Üdv a fedélzeten", size: "text-xl", opacity: "opacity-80", top: '82%', left: '10%', fontWeight: '500', duration: '39s', delay: '-15s' },
    { text: "Vitajte na palube", size: "text-lg", opacity: "opacity-75", top: '38%', left: '60%', fontWeight: '400', duration: '44s', delay: '-20s' },
    { text: "Mire se erdhët në bord", size: "text-2xl", opacity: "opacity-85", top: '62%', left: '80%', fontWeight: '600', duration: '31s', delay: '-7s' },
    { text: "Mirë se vjen", size: "text-xl", opacity: "opacity-80", top: '7%', left: '40%', fontWeight: '500', duration: '36s', delay: '-12s' },
    { text: "Bienvenida", size: "text-3xl", opacity: "opacity-90", top: '95%', left: '2%', fontWeight: '700', duration: '29s', delay: '-6s' },
    { text: "Willkommen", size: "text-2xl", opacity: "opacity-85", top: '45%', left: '75%', fontWeight: '600', duration: '32s', delay: '-8s' },
    ...
    { text: "Καλώς ορίσατε", size: "text-2xl", opacity: "opacity-85", top: '55%', left: '95%', fontWeight: '600', duration: '33s', delay: '-9s' },
    { text: "أهلاً وسهلاً", size: "text-4xl", opacity: "opacity-95", top: '20%', left: '85%', fontWeight: '700', direction: 'rtl', duration: '25s', delay: '-2s' },
    ...
    { text: "Benvinguda", size: "text-xl", opacity: "opacity-80", top: '10%', left: '75%', fontWeight: '500', duration: '37s', delay: '-13s' },
    { text: "Fáilte", size: "text-lg", opacity: "opacity-75", top: '60%', left: '60%', fontWeight: '400', duration: '42s', delay: '-18s' },
    { text: "Croeso", size: "text-2xl", opacity: "opacity-85", top: '5%', left: '95%', fontWeight: '600', duration: '31s', delay: '-7s' },
    { text: "Üdvözlet", size: "text-xl", opacity: "opacity-80", top: '95%', left: '95%', fontWeight: '500', duration: '39s', delay: '-15s' },
    ...
    { text: "Välkommen", size: "text-xl", opacity: "opacity-80", top: '33%', left: '90%', fontWeight: '500', duration: '40s', delay: '-16s' },
