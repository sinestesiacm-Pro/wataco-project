...
const WelcomeAboardCloud = () => {
    const words = [
        ...
        { text: "欢迎登机", size: "text-3xl", position: "top-1/2 left-1/2 -translate-x-[45%] -translate-y-[0%]", opacity: "opacity-90", duration: "9s", delay: "-1s" },
        { text: "Karibu", size: "text-2xl", position: "top-1/2 left-1/2 -translate-x-[40%] translate-y-[80%]", opacity: "opacity-80", duration: "10s", delay: "-2s" },

        // Left Side
        { text: "Bienvenido a bordo", size: "text-3xl", position: "top-[40%] left-[20%]", opacity: "opacity-90", duration: "10s", delay: "-0.5s" },
        { text: "Bem-vindo a bordo", size: "text-xl", position: "top-[48%] left-[22%]", opacity: "opacity-70", duration: "12s", delay: "-1.5s" },
        { text: "Bine aţi venit la bord", size: "text-lg", position: "top-[35%] left-[15%]", opacity: "opacity-80", duration: "9s", delay: "-2.5s" },
        ...
        { text: "어서 오세요", size: "text-2xl", position: "top-[50%] left-[38%]", opacity: "opacity-80", duration: "8s", delay: "-3s" },
        ...
        { text: "اهلا بكم على متن الطائرة", size: "text-lg", position: "top-[58%] left-[40%]", opacity: "opacity-60", duration: "11s", delay: "-6s" },
        { text: "Välkommen", size: "text-xl", position: "bottom-[15%] left-[5%]", opacity: "opacity-50", duration: "15s", delay: "-7s" },
        { text: "Fáilte romhat", size: "text-lg", position: "top-[45%] left-[45%]", opacity: "opacity-70", duration: "11s", delay: "-4.2s" },
