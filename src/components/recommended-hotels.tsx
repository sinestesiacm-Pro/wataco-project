...
const HotelCard = ({ hotel }: { hotel: typeof recommendedHotels[0] }) => (
    <Link href={`/hotels/${hotel.id}`} className="group">
        <Card className="bg-black/20 backdrop-blur-xl border border-white/20 rounded-2xl p-3 flex gap-4 transition-all duration-300 group-hover:bg-black/30 h-full">
