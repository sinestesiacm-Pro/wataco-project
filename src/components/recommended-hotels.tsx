        ...
        <CardContent className="p-4 flex flex-col flex-grow text-white">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="font-semibold text-2xl text-tertiary">${hotel.price}<span className="text-sm font-normal text-white/80">/noche</span></p>
                </div>
                <Button asChild className="font-semibold bg-tertiary hover:bg-tertiary/90 text-tertiary-foreground">
