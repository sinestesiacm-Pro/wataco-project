...
import { FlightData, FlightOffer, Segment } from '@/lib/types';
        ...
        return (
          <Card key={flight.id} className="overflow-hidden transition-shadow hover:shadow-lg">
            ...
            <CardContent className="p-4 md:p-6 flex flex-col md:flex-row items-center gap-4">
                  ...
                  />
                   <div className='w-full'>
                    ...
                    <div className="flex items-center text-xs text-muted-foreground space-x-4">
                      ...
                      <span className="flex items-center"><BaggageClaim className="w-3 h-3 mr-1" />{getBaggageInfo(flight)}</span>
                    </div>
                   </div>
                </div>
              ...
              <div className="md:border-l md:pl-6 w-full md:w-auto text-center md:text-right flex-shrink-0 mt-4 md:mt-0">
                  ...
                  <Button 
                    ...
                    onClick={() => alert(`Redirecting to book flight to ${itinerary.segments[itinerary.segments.length-1].arrival.iataCode}...`)}
                  >
                    Book Now
                  </Button>
              </div>
