...
const AnimatedClouds = () => (
    <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        ...
        {/* Nube 2: Inferior Derecha, visible al cargar */}
        ...
        {/* Nube 6: Grande y Rápida, empieza justo fuera de pantalla */}
        ...
        {/* Nube 7: Pequeña y Baja, visible al cargar */}
        ...
        {/* Nube 8: Central superior, visible al cargar */}
        ...
        {/* Nube 11: Superior, muy a la izquierda, visible al cargar */}
        ...
        <div className="cloud-container cloud-animation" style={{ top: '60%', left: '50vw', animationDuration: '125s' }}>
         ...
         {/* Nube 13: Media-alta, visible al cargar */}
        ...
        {/* Nube 14: Inferior, visible al cargar */}
