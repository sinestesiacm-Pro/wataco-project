...
const AnimatedClouds = () => (
    <div className="absolute top-0 left-0 w-full h-full overflow-x-hidden pointer-events-none z-0">
        {/* Nube 1: Grande y extendida, empieza visible a la izquierda */}
        <div className="cloud-container cloud-animation" style={{ top: '50%', left: '10%', animationDuration: '120s', animationDelay: '-60s' }}>
        ...
        {/* Nube 2: Mediana y alta, empieza fuera de pantalla a la derecha */}
        <div className="cloud-container cloud-animation" style={{ top: '15%', animationDuration: '90s', animationDelay: '0s' }}>
            <div className="cloud-part" style={{ width: '300px', height: '90px', top: '0', left: '0' }}></div>
        ...
        {/* Nube 3: Larga y baja, empieza visible en el centro */}
        <div className="cloud-container cloud-animation" style={{ top: '80%', left: '40%', animationDuration: '100s', animationDelay: '-30s' }}>
            <div className="cloud-part" style={{ width: '400px', height: '100px', top: '0', left: '0' }}></div>
            <div className="cloud-part" style={{ width: '250px', height: '80px', top: '15px', left: '75px' }}></div>
        </div>
        
        {/* Nube 4: Pequeña y rápida, empieza a mitad de ciclo a la izquierda */}
        <div className="cloud-container cloud-animation" style={{ top: '30%', left: '-10%', animationDuration: '75s', animationDelay: '-40s' }}>
            <div className="cloud-part" style={{ width: '250px', height: '80px', top: '0', left: '0' }}></div>
            <div className="cloud-part" style={{ width: '150px', height: '60px', top: '10px', left: '50px' }}></div>
        </div>
        ...
        {/* Nube 6: Muy grande y lenta, empieza fuera de pantalla */}
        <div className="cloud-container cloud-animation" style={{ top: '5%', animationDuration: '150s', animationDelay: '-10s' }}>
            ...
            <div className="cloud-part" style={{ width: '250px', height: '90px', top: '-15px', left: '150px' }}></div>
        </div>
