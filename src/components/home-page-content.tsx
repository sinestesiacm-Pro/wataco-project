...
const AnimatedClouds = () => (
    <div className="absolute top-0 left-0 w-full h-full overflow-x-hidden pointer-events-none z-0">
        {/* Nube 1: Superior Izquierda (lenta, visible al cargar) */}
        <div className="cloud-container cloud-animation" style={{ top: '10%', left: '5%', animationDuration: '120s', animationDelay: '-25s' }}>
        ...
        {/* Nube 3: Central, velocidad media (visible al cargar) */}
        ...
        {/* Nube 4: Superior Derecha (rápida, empieza fuera) */}
        ...
        {/* Nube 6: Grande y Rápida, empieza fuera de pantalla a la derecha */}
        ...
        {/* Nube 8: Central superior, velocidad media-rápida (visible al cargar) */}
        ...
        {/* Nube 9: Inferior izquierda, muy lenta (visible al cargar) */}
        ...
        {/* Nube 12: Central, muy lenta (visible al cargar) */}
        <div className="cloud-container cloud-animation" style={{ top: '60%', left: '50%', animationDuration: '125s', animationDelay: '-110s' }}>
         ...
         {/* Nube 13: Media-alta, empieza a la izquierda (visible al cargar) */}
        ...
        {/* Nube 14: Inferior, empieza en el centro (visible al cargar) */}
