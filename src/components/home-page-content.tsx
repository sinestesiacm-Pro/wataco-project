...
const AnimatedClouds = () => (
    <div className="absolute top-0 left-0 w-full h-full overflow-x-hidden pointer-events-none z-0">
        {/* Nube 1: Larga y simétrica, empieza visible */}
        <div className="cloud-container cloud-animation" style={{ top: '15%', left: '20%', animationDuration: '90s', animationDelay: '-15s' }}>
        ...
        {/* Nube 2: Normal, empieza fuera de pantalla */}
        ...
        {/* Nube 3: Grande y extendida, empieza visible */}
        ...
        {/* Nube 4: Pequeña y larga, empieza fuera de pantalla */}
        <div className="cloud-container cloud-animation" style={{ top: '65%', animationDuration: '60s', animationDelay: '-5s' }}>
        ...
        {/* Nube 5: Mediana, empieza visible */}
        <div className="cloud-container cloud-animation" style={{ top: '80%', left: '10%', animationDuration: '100s', animationDelay: '-30s' }}>
        ...
        {/* Nube 6: Otra grande, empieza fuera de pantalla */}
        ...
        {/* Nube 7: Rápida y pequeña, empieza fuera de pantalla */}
        <div className="cloud-container cloud-animation" style={{ top: '90%', animationDuration: '55s', animationDelay: '-25s' }}>
