...
import { ArrowLeft, ArrowRight, Clock, Luggage, Plane } from 'lucide-react';
    ...
    return (
        <div className="flex gap-4 items-start relative pl-8">
            <div className="absolute left-0 top-0 flex flex-col items-center h-full">
                <div className="w-4 h-4 rounded-full bg-primary border-2 border-card"></div>
                <div className="flex-grow w-px bg-border my-1"></div>
            </div>
            <div>
                <p className="font-semibold">{formatDate(segment.departure.at)}</p>
                        ...
                        <div key={segment.id}>
                            ...
                            {!isLastSegment && (
                                <div className="relative pl-8 py-2">
                                    ...
                                    <div className="flex items-center gap-2 text-sm font-semibold text-primary ml-4">
                                        <Clock className="w-4 h-4" />
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button 
            size="lg"
            className="w-full font-bold bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl shadow-md hover:shadow-lg transition-all"
        >
            Seleccionar
      ...
      <DialogContent className="sm:max-w-3xl max-h-[90vh] flex flex-col bg-card/95 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 overflow-y-auto pr-2">
              ...
              <div className="md:col-span-4 space-y-4">
                  ...
                  <Card className="p-4 rounded-xl border-primary/50">
