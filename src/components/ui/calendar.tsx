  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-tertiary/20 text-tertiary-foreground",
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-primary/50 aria-selected:text-muted-foreground",
