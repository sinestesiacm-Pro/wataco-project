            ...
            <TabsList className="grid w-full grid-cols-5 max-w-2xl mx-auto bg-card/80 backdrop-blur-sm">
                {Object.keys(destinationsByContinent).map(continent => (
                    <TabsTrigger 
                        ...
                        className={cn(activeTab === continent && "bg-background shadow-sm")}
                    >
                        {continent}
                    </TabsTrigger>
                ))}
        ...
        <div className="relative mt-8">
            {Object.entries(destinationsByContinent).map(([continent, destinations]) => (
                <TabsContent 
                    ...
                    forceMount
                    className={cn(
                        "data-[state=active]:animate-in data-[state=active]:fade-in-50 duration-500",
                        activeTab !== continent && "hidden"
                    )}
                >
                    <div className="flex space-x-8 pb-12 overflow-x-auto scrollbar-hide -mx-4 px-4 mask-fade">
