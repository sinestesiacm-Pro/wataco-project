...
const flightRoutes = [
  ...
  { origin: 'MIA', originCity: 'Miami', destination: 'MDE', destinationCity: 'Medellín', hint: 'medellin comuna 13', image: 'https://images.unsplash.com/photo-1512250431446-d0b4b57b27ec?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyfHxtZWRlbGxpbnxlbnwwfHx8fDE3NTQxMzcyODh8MA&ixlib=rb-4.1.0&q=80&w=1080', simulatedPrice: '480' },
