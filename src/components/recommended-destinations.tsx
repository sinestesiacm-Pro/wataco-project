...
const flightRoutes = [
  ...
  { origin: 'DXB', originCity: 'Dubai', destination: 'LHR', destinationCity: 'London', hint: 'london city', image: 'https://images.unsplash.com/photo-1533929736458-ca588d08c8be?w=500', simulatedPrice: '600' },
];
