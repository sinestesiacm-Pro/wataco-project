...
function CruiseDetailPageContent({ cruise }: { cruise: CruisePackage }) {
    ...
    // ¡PEGAR LAS LÍNEAS DE CONSOLE.LOG() AQUÍ MISMO!
    console.log('--- DEPURACIÓN VIDEO SOURCE (NECESIDAD DE EVIDENCIA REAL) ---');
    console.log('Componente renderizando:', 'CruiseDetailPageContent (Cliente Component)'); // Confirmación del componente
    ...
    console.log('--- FIN DEPURACIÓN VIDEO SOURCE (NECESIDAD DE EVIDENCIA REAL) ---');
